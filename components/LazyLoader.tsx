...
export const LazyAnimationController = lazy(() => import('./AnimationController').then(m => ({ default: m.AnimationController })));
...
export const LazyEnhancedThemeProvider = lazy(() => import('./EnhancedThemeProvider').then(m => ({ default: m.EnhancedThemeProvider })) );
...
export const LazyNotificationSystem = lazy(() => import('./NotificationSystem').then(m => ({ default: m.NotificationProvider })) );
...
export const LazyThemeProvider = lazy(() => import('./ThemeProvider').then(m => ({ default: m.ThemeProvider })) );

...
const CompanyInfoWidget: React.FC<CompanyInfoWidgetProps> = ({
  ...
  const content = {
    ...
    en: {
      ...
      tagline: "Your trusted partner for professional cleaning services in Jeddah",
      description: "We use the latest international equipment with a team of trained specialists to ensure the highest standards of cleanliness and quality",
  ...
  const googleBusinessUrl = "https://business.google.com/n/7234567890123456789/searchprofile?hl=ar";
  ...
  return (
    <Card className={`w-full max-w-4xl mx-auto ${className}`} dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">{COMPANY_STATS.experience}</div>
                  <div className="text-xs text-gray-600">{COMPANY_STATS.experienceLabel}</div>
                </div>
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{COMPANY_STATS.projects}</div>
                  <div className="text-xs text-gray-600">{COMPANY_STATS.projectsLabel}</div>
                </div>
                <div className="text-center p-3 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">{COMPANY_STATS.employees}</div>
                  <div className="text-xs text-gray-600">{COMPANY_STATS.employeesLabel}</div>
                </div>
                <div className="text-center p-3 bg-yellow-50 rounded-lg">
                  <div className="text-2xl font-bold text-yellow-600">{COMPANY_STATS.satisfaction}</div>
                  <div className="text-xs text-gray-600">{COMPANY_STATS.satisfactionLabel}</div>
                </div>
              </div>
            </div>
          </>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4">
          ...
          >
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">
              ...
              {currentLanguage === 'ar' ? 'تواصل عبر واتساب' : 'Contact via WhatsApp'}
            </a>
          </Button>

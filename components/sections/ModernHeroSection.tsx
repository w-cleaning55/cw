        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[90vh] py-12">
          ...
          <div className="text-white space-y-8">
            ...
            <p
              ...
              dir="rtl"
            >
              شريككم الموثوق لخدمات التنظيف المحترفة مع ضمان الجودة والتميز في
              كل مشروع
            </p>
              ...
              {[
                {
                  ...
                  text: "أحدث المعدات العالمية",
                },
                {
                  icon: <Award className="w-5 h-5" />,
                  text: "فريق متخصص ومدرب",
                },
                {
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-8">
                    {[
                      {
                        icon: <HomeIcon size="lg" className="text-blue-300" />,
                        label: "المنازل",
                      },
                      {
                        icon: (
                          <BuildingIcon size="lg" className="text-cyan-300" />
                        ),
                        label: "المكاتب",
                      },
                      {
                        icon: (
                          <SparkleIcon size="lg" className="text-purple-300" />
                        ),
                        label: "السجاد",
                      },
                      {
                        icon: (
                          <SparkleIcon size="lg" className="text-yellow-300" />
                        ),
                        label: "الرخام",
                      },
                      {
                        icon: <WaterIcon size="lg" className="text-blue-400" />,
                        label: "الخزانات",
                      },
                      {
                        icon: (
                          <ShieldIcon size="lg" className="text-green-300" />
                        ),
                        label: "الحشرات",
                      },
                    ].map((service, index) => (
                      <div
                        key={index}
                        className="text-center p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105"
                      >
